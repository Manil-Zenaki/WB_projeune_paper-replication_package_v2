...
&&&&(0.011)&(0.011)&(0.011)\\
Proportion of males in the network (z-score) &&&&-0.035**&-0.034**&-0.033**\\
&&&&(0.017)&(0.016)&(0.016)\\
\textbf{Role model and support}&&&&&&\\
Male role model&&&&&-0.029&-0.029\\
&&&&&(0.023)&(0.023)\\
Female role model&&&&&0.061&0.061\\
&&&&&(0.041)&(0.038)\\
Can seek professional advice from individuals outside the family &&&&&0.042&0.041\\
&&&&&(0.028)&(0.028)\\
\textbf{Gender attitudes and agency}&&&&&&\\
Gender attitudes (z-score)&&&&&&-0.004\\
&&&&&&(0.010)\\
Agency: input in productive decisions (z-score) &&&&&&-0.010\\
&&&&&&(0.013)\\
