...
label var age_resp_z "Age of the respondent (z-score)" 
...
label var nkids_dependent_z "Number of dependent children (z-score)"
...
label var educbis_z "Years of education (z-score)"
...
label var worked_`x' "Worked in `x' in the last 30d"
...
label var train_energy_ict "Already received training in EICT in the past"


label var worked_energy_ict "Worked in EICT in the last 30d"
...
label var employed30d_dummy "Wage-employed in the last 30d"
label var train_dummy "Any training" 
label var selfemployed30d_dummy "Self-employed in the last 30d"
...
label var worked_paid30d_dummy "Had a paid work in the last 30d"
...
label var n5_size "Network size"
label var n5_size_z "Network size (z-score)" 



label var n5_any "Has a professional Network"
...
label var n5_male_prop_z "Proportion of males in the network (z-score)"
...
label var rm_energy_ict "Role model in EICT" 
label var rm_female "Female role model"
label var rm_male "Male role model"
...
foreach x in male female {
	...
	label var rm_mds_`x' "Has a `x' role model working in a Male Dominated Sector"
	label var rm_eict_`x' "Has a `x' role model working in the energy or ICT sectors"
	label var rm_fr_`x' "Role model is a `x' friend"
	label var rm_fam_`x' "Role model is a `x' family member"
...
label var support_bothsex "Can seek professional advice from individuals outside the family"
...
**************************************
label var ga_cook "Agrees that women’s most important role is to cook and take care of her household" 
...
label var ga_score_z  "Gender attitudes (z-score)"
label var ga_score_p "Gender attitudes [0,1]"
...
label var agencycom_general_p "Agency: input in productive decisions [0,1]"
label var agency_general_zscore "Perceived ability to take his/her own decision (zscore)" 
label var agency_general_z "Agency: input in productive decisions (z-score)"
...
** K.1 Revenues ** 
label var revenues_total "Revenues earned in the last 30d (USD PPP)"
label var revenues_total_z "Revenues earned in the last 30d (z-score)"
label var revenues_total_q "Quintiles of total revenue earned during the last 30days"
label var revenues_aspiration "Monthly income would like to achieve in 10 years"
...
label var wealthindex_hh_z "Household wealth index by cohort (z-score)"
...
label var train_choice_energy "Vocational training in energy"
label var train_choice_lipton "Vocational training in trade"
label var train_choice_salaried "Wage-employement track"
label var train_choice_selfemp "Generalist entrepreneurial track"
label var train_choice_tic "Vocational training in information and communication technologies (ICT)"
label var train_choice_vt "Vocational training track"
...
label var dm_attitude_p "Attitudes towards domestic violence [0,1]"
label var dm_attitude_zscore "Attitude towards domestic violence (z-score)"
label var dm_attitude_score_z "Attitude towards domestic violence (z-score)"
