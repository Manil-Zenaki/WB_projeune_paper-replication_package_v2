...
local work   worked_paid30d_dummy  worked_energy_ict revenues_total // employment and earnings 

local network n5_size n5_male_prop // network 

local rm_support rm_male rm_female rm_energy_ict support  // role models and support

local ga_agency_dm ga_score_p  agency_general_p dm_attitude_p  // gender attitudes, agency, domestic violence
...
using  "$Table_slides/descriptive_statistics_short.tex" ,  ///
